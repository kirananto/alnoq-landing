  ...
  return (
    <header className="text-emerald-50 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <button className="hidden md:inline-flex items-center bg-emerald-700 invisible md:visible border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Contact us
