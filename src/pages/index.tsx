...
const IndexPage: React.FC<PageProps> = () => {
  return (<>
    <main className="text-orange-50 bg-[#150d12] antialiased" style={mainStyle}>
      <NavBar />
      <HeroSection />
      <section className="text-orange-100 bg-orange-700 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-8">
          <h1 className="sm:text-3xl text-2xl font-bold title-font text-orange-50 mb-4">Multi Tenancy from Day 1 🏆</h1>
      ...
      <section className="text-orange-100 bg-orange-700 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-8">
          <h1 className="sm:text-3xl text-2xl font-bold title-font text-orange-50 mb-4">As a modern SaaS enterprise, you either try to build it or ignore such capabilities. <br/> But not anymore. </h1>
          </div>
        </div>
      </section>
      <Footer />
